...
typedef struct user_message user_message_t;

typedef struct heartbeat_message heartbeat_message_t;

typedef struct user_joined_message user_joined_message_t;

typedef struct user_left_message user_left_message_t;
...
/** Byte size of the fixed block for UserMessage (padded for alignment). */
...
struct user_message {
    ...
    char* content;     /**< Heap-allocated; call user_message_free() when done. */
    uint32_t attachment_len;
    uint8_t* attachment;     /**< Heap-allocated; call user_message_free() when done. */
};
 ...
 * all variable-length fields in the UserMessage message from the fixed payload.
 */
uint32_t calculate_user_message_dynamic_payload_size(const uint8_t* hdr_buf);
 ...
 */
int user_message_unmarshal(const uint8_t* in_buf, uint16_t fixed_payload_len,
		uint32_t overall_payload_len, user_message_t* out_msg);
...
/** Byte size of the fixed block for HeartbeatMessage (padded for alignment). */
 ...
 * all variable-length fields in the HeartbeatMessage message from the fixed payload.
 */
uint32_t calculate_heartbeat_message_dynamic_payload_size(const uint8_t* hdr_buf);
 ...
 * any heap-allocated variable-length fields.
 */
int heartbeat_message_unmarshal(const uint8_t* in_buf, uint16_t fixed_payload_len,
		uint32_t overall_payload_len, heartbeat_message_t* out_msg);
...
/** Byte size of the fixed block for UserJoinedMessage (padded for alignment). */
 ...
 * IMPORTANT: Do not reorder fields. The layout must match the wire format.
 */
struct user_joined_message {
    int64_t timestamp;
    uint32_t username_len;
    char* username;     /**< Heap-allocated; call user_joined_message_free() when done. */
 ...
 * all variable-length fields in the UserJoinedMessage message from the fixed payload.
 */
uint32_t calculate_user_joined_message_dynamic_payload_size(const uint8_t* hdr_buf);
 ...
 * any heap-allocated variable-length fields.
 */
int user_joined_message_unmarshal(const uint8_t* in_buf, uint16_t fixed_payload_len,
		uint32_t overall_payload_len, user_joined_message_t* out_msg);
...
/** Byte size of the fixed block for UserLeftMessage (padded for alignment). */
 ...
 * IMPORTANT: Do not reorder fields. The layout must match the wire format.
 */
struct user_left_message {
    int64_t timestamp;
    uint32_t username_len;
    char* username;     /**< Heap-allocated; call user_left_message_free() when done. */
    uint8_t _pad0[4]; /**< Explicit alignment padding. */
};
 ...
 * all variable-length fields in the UserLeftMessage message from the fixed payload.
 */
uint32_t calculate_user_left_message_dynamic_payload_size(const uint8_t* hdr_buf);
 ...
 * any heap-allocated variable-length fields.
 */
int user_left_message_unmarshal(const uint8_t* in_buf, uint16_t fixed_payload_len,
		uint32_t overall_payload_len, user_left_message_t* out_msg);
