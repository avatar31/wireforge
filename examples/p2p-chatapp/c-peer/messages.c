...
/* ===========================================================================
 * UserMessage (Type ID: 1, Fixed Payload: 16 bytes)
 * ===========================================================================*/
...
int user_message_marshal(const user_message_t* msg, uint8_t** out_buf) {
    ...
    uint32_t payload_size = USER_MESSAGE_FIXED_SIZE + dyn_size;
    ...
    put_u16_be(buf + WIRE_FRAME_MSG_FIXED_PAYLOAD_SIZE, USER_MESSAGE_FIXED_SIZE);
...
int user_message_unmarshal(const uint8_t* in_buf, uint16_t fixed_payload_len,
    ...
    if (!in_buf || !out_msg ||
        fixed_payload_len < USER_MESSAGE_FIXED_SIZE ||
    ...
    if (out_msg->content_len > 0) {
        if (out_msg->content_len > MAX_ALLOWED_PACKET ||
            dyn_off + out_msg->content_len > overall_payload_len) {
    ...
    if (out_msg->attachment_len > 0) {
        if (out_msg->attachment_len > MAX_ALLOWED_PACKET ||
            dyn_off + out_msg->attachment_len > overall_payload_len) {
            user_message_free(out_msg);
            return -1;
        }
...
/* ===========================================================================
 * HeartbeatMessage (Type ID: 2, Fixed Payload: 8 bytes)
 * ===========================================================================*/
...
int heartbeat_message_marshal(const heartbeat_message_t* msg, uint8_t** out_buf) {
    ...
    uint32_t payload_size = HEARTBEAT_MESSAGE_FIXED_SIZE + dyn_size;
    size_t total_size = WIRE_FRAME_HEADER_SIZE + payload_size;
    if (total_size > MAX_ALLOWED_PACKET) {
        return -1;
    }
    ...
    put_u16_be(buf + WIRE_FRAME_MSG_FIXED_PAYLOAD_SIZE, HEARTBEAT_MESSAGE_FIXED_SIZE);
    put_u32_be(buf + WIRE_FRAME_MSG_OVERALL_PAYLOAD_SIZE, payload_size);
...
int heartbeat_message_unmarshal(const uint8_t* in_buf, uint16_t fixed_payload_len,
    ...
    if (!in_buf || !out_msg ||
        fixed_payload_len < HEARTBEAT_MESSAGE_FIXED_SIZE ||
        overall_payload_len < fixed_payload_len ||
        overall_payload_len > MAX_ALLOWED_PACKET) {
        return -1;
    }
...
/* ===========================================================================
 * UserJoinedMessage (Type ID: 3, Fixed Payload: 16 bytes)
 * ===========================================================================*/
...
int user_joined_message_marshal(const user_joined_message_t* msg, uint8_t** out_buf) {
    ...
    uint32_t payload_size = USER_JOINED_MESSAGE_FIXED_SIZE + dyn_size;
    size_t total_size = WIRE_FRAME_HEADER_SIZE + payload_size;
    if (total_size > MAX_ALLOWED_PACKET) {
        return -1;
    }
    ...
    put_u16_be(buf + WIRE_FRAME_MSG_FIXED_PAYLOAD_SIZE, USER_JOINED_MESSAGE_FIXED_SIZE);
    put_u32_be(buf + WIRE_FRAME_MSG_OVERALL_PAYLOAD_SIZE, payload_size);
...
int user_joined_message_unmarshal(const uint8_t* in_buf, uint16_t fixed_payload_len,
    ...
    if (!in_buf || !out_msg ||
        fixed_payload_len < USER_JOINED_MESSAGE_FIXED_SIZE ||
        overall_payload_len < fixed_payload_len ||
        overall_payload_len > MAX_ALLOWED_PACKET) {
        return -1;
    }
    ...
    if (out_msg->username_len > 0) {
        if (out_msg->username_len > MAX_ALLOWED_PACKET ||
            dyn_off + out_msg->username_len > overall_payload_len) {
...
/* ===========================================================================
 * UserLeftMessage (Type ID: 4, Fixed Payload: 16 bytes)
 * ===========================================================================*/
...
int user_left_message_marshal(const user_left_message_t* msg, uint8_t** out_buf) {
    ...
    uint32_t payload_size = USER_LEFT_MESSAGE_FIXED_SIZE + dyn_size;
    size_t total_size = WIRE_FRAME_HEADER_SIZE + payload_size;
    if (total_size > MAX_ALLOWED_PACKET) {
        return -1;
    }
    ...
    put_u16_be(buf + WIRE_FRAME_MSG_FIXED_PAYLOAD_SIZE, USER_LEFT_MESSAGE_FIXED_SIZE);
    put_u32_be(buf + WIRE_FRAME_MSG_OVERALL_PAYLOAD_SIZE, payload_size);
...
int user_left_message_unmarshal(const uint8_t* in_buf, uint16_t fixed_payload_len,
    ...
    if (!in_buf || !out_msg ||
        fixed_payload_len < USER_LEFT_MESSAGE_FIXED_SIZE ||
        overall_payload_len < fixed_payload_len ||
        overall_payload_len > MAX_ALLOWED_PACKET) {
        return -1;
    }
